...
\begin{document}
    ...
    فاصلۀ دامرو-لونشتاین \Latincite{damerau_1964} مشابه فاصلۀ لونشتاین است. تنها فرق آن این است که فاصلۀ دامرو-لونشتاین یک عملیات دیگر را مجاز می‌شمارد: ترانهش\footnote{Transposition}  دو نویسۀ مجاور. شبه‌کد محاسبۀ فاصلۀ دامرو-لونشتاین در برنامه \ref{listing:3} آمده است.
